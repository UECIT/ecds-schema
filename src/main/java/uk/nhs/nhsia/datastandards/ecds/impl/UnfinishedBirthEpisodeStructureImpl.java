 ...
 */
public class UnfinishedBirthEpisodeStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure
{
    private static final long serialVersionUID = 1L;
    
    public UnfinishedBirthEpisodeStructureImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure.EpisodeCharacteristics getEpisodeCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure.EpisodeCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure.EpisodeCharacteristics)get_store().find_element_user(EPISODECHARACTERISTICS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEpisodeCharacteristics(uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure.EpisodeCharacteristics episodeCharacteristics)
    {
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure.EpisodeCharacteristics addNewEpisodeCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure.EpisodeCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure.EpisodeCharacteristics)get_store().add_element_user(EPISODECHARACTERISTICS$0);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class EpisodeCharacteristicsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.UnfinishedBirthEpisodeStructure.EpisodeCharacteristics
    {
        private static final long serialVersionUID = 1L;
