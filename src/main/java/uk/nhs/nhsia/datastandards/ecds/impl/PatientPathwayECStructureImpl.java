 ...
 */
public class PatientPathwayECStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure
{
    private static final long serialVersionUID = 1L;
    
    public PatientPathwayECStructureImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.PatientPathwayIdentity getPatientPathwayIdentity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.PatientPathwayIdentity target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.PatientPathwayIdentity)get_store().find_element_user(PATIENTPATHWAYIDENTITY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPatientPathwayIdentity(uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.PatientPathwayIdentity patientPathwayIdentity)
    {
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.PatientPathwayIdentity addNewPatientPathwayIdentity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.PatientPathwayIdentity target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.PatientPathwayIdentity)get_store().add_element_user(PATIENTPATHWAYIDENTITY$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.RTTPeriodCharacteristics getRTTPeriodCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.RTTPeriodCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.RTTPeriodCharacteristics)get_store().find_element_user(RTTPERIODCHARACTERISTICS$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRTTPeriodCharacteristics(uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.RTTPeriodCharacteristics rttPeriodCharacteristics)
    {
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.RTTPeriodCharacteristics addNewRTTPeriodCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.RTTPeriodCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.RTTPeriodCharacteristics)get_store().add_element_user(RTTPERIODCHARACTERISTICS$2);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class PatientPathwayIdentityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.PatientPathwayIdentity
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName ORGANISATIONIDENTIFIERPATIENTPATHWAYIDENTIFIERISSUER$4 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "OrganisationIdentifier_PatientPathwayIdentifierIssuer");
         ...
         */
        public java.lang.String getOrganisationIdentifierPatientPathwayIdentifierIssuer()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(ORGANISATIONIDENTIFIERPATIENTPATHWAYIDENTIFIERISSUER$4, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public uk.nhs.nhsia.datastandards.ecds.OrgIdenECType xgetOrganisationIdentifierPatientPathwayIdentifierIssuer()
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.nhsia.datastandards.ecds.OrgIdenECType target = null;
                target = (uk.nhs.nhsia.datastandards.ecds.OrgIdenECType)get_store().find_element_user(ORGANISATIONIDENTIFIERPATIENTPATHWAYIDENTIFIERISSUER$4, 0);
                return target;
            }
        }
         ...
         */
        public void setOrganisationIdentifierPatientPathwayIdentifierIssuer(java.lang.String organisationIdentifierPatientPathwayIdentifierIssuer)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(ORGANISATIONIDENTIFIERPATIENTPATHWAYIDENTIFIERISSUER$4);
                }
                target.setStringValue(organisationIdentifierPatientPathwayIdentifierIssuer);
            }
        }
         ...
         */
        public void xsetOrganisationIdentifierPatientPathwayIdentifierIssuer(uk.nhs.nhsia.datastandards.ecds.OrgIdenECType organisationIdentifierPatientPathwayIdentifierIssuer)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.OrgIdenECType)get_store().add_element_user(ORGANISATIONIDENTIFIERPATIENTPATHWAYIDENTIFIERISSUER$4);
                }
                target.set(organisationIdentifierPatientPathwayIdentifierIssuer);
            }
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class RTTPeriodCharacteristicsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.PatientPathwayECStructure.RTTPeriodCharacteristics
    {
        private static final long serialVersionUID = 1L;
