/*
 * XML Type:  UnfinishedGeneralEpisode_Structure
 * Namespace: http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns
 * Java type: uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure
 *
 * Automatically generated - do not modify.
 */
package uk.nhs.nhsia.datastandards.ecds.impl;
/**
 * An XML UnfinishedGeneralEpisode_Structure(@http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns).
 *
 * This is a complex type.
 */
public class UnfinishedGeneralEpisodeStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure
{
    private static final long serialVersionUID = 1L;
    
    public UnfinishedGeneralEpisodeStructureImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure.EpisodeCharacteristics getEpisodeCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure.EpisodeCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure.EpisodeCharacteristics)get_store().find_element_user(EPISODECHARACTERISTICS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEpisodeCharacteristics(uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure.EpisodeCharacteristics episodeCharacteristics)
    {
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure.EpisodeCharacteristics addNewEpisodeCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure.EpisodeCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure.EpisodeCharacteristics)get_store().add_element_user(EPISODECHARACTERISTICS$0);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class EpisodeCharacteristicsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.UnfinishedGeneralEpisodeStructure.EpisodeCharacteristics
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName FIRSTREGULARDAYORNIGHTADMISSIONCODE$8 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "FirstRegularDayOrNightAdmissionCode");
        private static final javax.xml.namespace.QName PSYCHIATRICPATIENTSTATUSCODE$10 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "PsychiatricPatientStatusCode");
        private static final javax.xml.namespace.QName STARTDATEEPISODE$12 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "StartDate_Episode");
        private static final javax.xml.namespace.QName STARTTIMEEPISODE$14 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "StartTime_Episode");
        private static final javax.xml.namespace.QName ENDDATEEPISODE$16 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "EndDate_Episode");
        private static final javax.xml.namespace.QName ENDTIMEEPISODE$18 = 
        ...
        private static final javax.xml.namespace.QName MULTIPROFORDISCINDCODE$22 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "MultiProfOrDiscIndCode");
        private static final javax.xml.namespace.QName REHABILITATIONASSESSMENTTEAMTYPE$24 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "RehabilitationAssessmentTeamType");
        private static final javax.xml.namespace.QName CONSULTANTEPISODELENGTHOFSTAYADJUSTMENT$26 = 
            new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "ConsultantEpisodeLengthOfStayAdjustment");
        private static final javax.xml.namespace.QName OVERSEASVISITORSTATUS$28 = 
        ...
        /**
         * Gets the "FirstRegularDayOrNightAdmissionCode" element
         */
        public uk.nhs.nhsia.datastandards.ecds.FirstRegularDayOrNightAdmissionCodeType.Enum getFirstRegularDayOrNightAdmissionCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(FIRSTREGULARDAYORNIGHTADMISSIONCODE$8, 0);
                if (target == null)
                {
                    return null;
                }
                return (uk.nhs.nhsia.datastandards.ecds.FirstRegularDayOrNightAdmissionCodeType.Enum)target.getEnumValue();
            }
        }
        
        /**
         * Gets (as xml) the "FirstRegularDayOrNightAdmissionCode" element
         */
        public uk.nhs.nhsia.datastandards.ecds.FirstRegularDayOrNightAdmissionCodeType xgetFirstRegularDayOrNightAdmissionCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.nhsia.datastandards.ecds.FirstRegularDayOrNightAdmissionCodeType target = null;
                target = (uk.nhs.nhsia.datastandards.ecds.FirstRegularDayOrNightAdmissionCodeType)get_store().find_element_user(FIRSTREGULARDAYORNIGHTADMISSIONCODE$8, 0);
                return target;
            }
        }
        
        /**
         * True if has "FirstRegularDayOrNightAdmissionCode" element
         */
        public boolean isSetFirstRegularDayOrNightAdmissionCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                return get_store().count_elements(FIRSTREGULARDAYORNIGHTADMISSIONCODE$8) != 0;
            }
        }
        
        /**
         * Sets the "FirstRegularDayOrNightAdmissionCode" element
         */
        public void setFirstRegularDayOrNightAdmissionCode(uk.nhs.nhsia.datastandards.ecds.FirstRegularDayOrNightAdmissionCodeType.Enum firstRegularDayOrNightAdmissionCode)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(FIRSTREGULARDAYORNIGHTADMISSIONCODE$8);
                }
                target.setEnumValue(firstRegularDayOrNightAdmissionCode);
            }
        }
        
        /**
         * Sets (as xml) the "FirstRegularDayOrNightAdmissionCode" element
         */
        public void xsetFirstRegularDayOrNightAdmissionCode(uk.nhs.nhsia.datastandards.ecds.FirstRegularDayOrNightAdmissionCodeType firstRegularDayOrNightAdmissionCode)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.FirstRegularDayOrNightAdmissionCodeType)get_store().add_element_user(FIRSTREGULARDAYORNIGHTADMISSIONCODE$8);
                }
                target.set(firstRegularDayOrNightAdmissionCode);
            }
        }
        
        /**
         * Unsets the "FirstRegularDayOrNightAdmissionCode" element
         */
        public void unsetFirstRegularDayOrNightAdmissionCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_element(FIRSTREGULARDAYORNIGHTADMISSIONCODE$8, 0);
            }
        }
        ...
        public uk.nhs.nhsia.datastandards.ecds.PsychiatricPatientStatusCodeType.Enum getPsychiatricPatientStatusCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(PSYCHIATRICPATIENTSTATUSCODE$10, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public uk.nhs.nhsia.datastandards.ecds.PsychiatricPatientStatusCodeType xgetPsychiatricPatientStatusCode()
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.nhsia.datastandards.ecds.PsychiatricPatientStatusCodeType)get_store().find_element_user(PSYCHIATRICPATIENTSTATUSCODE$10, 0);
                return target;
            }
        }
        ...
        public boolean isSetPsychiatricPatientStatusCode()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(PSYCHIATRICPATIENTSTATUSCODE$10) != 0;
            }
        }
        ...
        public void setPsychiatricPatientStatusCode(uk.nhs.nhsia.datastandards.ecds.PsychiatricPatientStatusCodeType.Enum psychiatricPatientStatusCode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(PSYCHIATRICPATIENTSTATUSCODE$10);
                }
        ...
        public void xsetPsychiatricPatientStatusCode(uk.nhs.nhsia.datastandards.ecds.PsychiatricPatientStatusCodeType psychiatricPatientStatusCode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.PsychiatricPatientStatusCodeType)get_store().add_element_user(PSYCHIATRICPATIENTSTATUSCODE$10);
                }
        ...
        public void unsetPsychiatricPatientStatusCode()
        {
            ...
            {
                check_orphaned();
                get_store().remove_element(PSYCHIATRICPATIENTSTATUSCODE$10, 0);
            }
        }
        ...
        public java.util.Calendar getStartDateEpisode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(STARTDATEEPISODE$12, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public uk.nhs.nhsia.datastandards.ecds.StartDateEpisodeType xgetStartDateEpisode()
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.nhsia.datastandards.ecds.StartDateEpisodeType)get_store().find_element_user(STARTDATEEPISODE$12, 0);
                return target;
            }
        }
        ...
        public void setStartDateEpisode(java.util.Calendar startDateEpisode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(STARTDATEEPISODE$12);
                }
        ...
        public void xsetStartDateEpisode(uk.nhs.nhsia.datastandards.ecds.StartDateEpisodeType startDateEpisode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.StartDateEpisodeType)get_store().add_element_user(STARTDATEEPISODE$12);
                }
        ...
        public java.util.Calendar getStartTimeEpisode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(STARTTIMEEPISODE$14, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public uk.nhs.nhsia.datastandards.ecds.StartTimeEpisodeType xgetStartTimeEpisode()
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.nhsia.datastandards.ecds.StartTimeEpisodeType)get_store().find_element_user(STARTTIMEEPISODE$14, 0);
                return target;
            }
        }
        ...
        public boolean isSetStartTimeEpisode()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(STARTTIMEEPISODE$14) != 0;
            }
        }
        ...
        public void setStartTimeEpisode(java.util.Calendar startTimeEpisode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(STARTTIMEEPISODE$14);
                }
        ...
        public void xsetStartTimeEpisode(uk.nhs.nhsia.datastandards.ecds.StartTimeEpisodeType startTimeEpisode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.StartTimeEpisodeType)get_store().add_element_user(STARTTIMEEPISODE$14);
                }
        ...
        public void unsetStartTimeEpisode()
        {
            ...
            {
                check_orphaned();
                get_store().remove_element(STARTTIMEEPISODE$14, 0);
            }
        }
        ...
        public java.util.Calendar getEndDateEpisode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(ENDDATEEPISODE$16, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public uk.nhs.nhsia.datastandards.ecds.EndDateEpisodeType xgetEndDateEpisode()
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.nhsia.datastandards.ecds.EndDateEpisodeType)get_store().find_element_user(ENDDATEEPISODE$16, 0);
                return target;
            }
        }
        ...
        public boolean isSetEndDateEpisode()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(ENDDATEEPISODE$16) != 0;
            }
        }
        ...
        public void setEndDateEpisode(java.util.Calendar endDateEpisode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(ENDDATEEPISODE$16);
                }
        ...
        public void xsetEndDateEpisode(uk.nhs.nhsia.datastandards.ecds.EndDateEpisodeType endDateEpisode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.EndDateEpisodeType)get_store().add_element_user(ENDDATEEPISODE$16);
                }
        ...
        public void unsetEndDateEpisode()
        {
            ...
            {
                check_orphaned();
                get_store().remove_element(ENDDATEEPISODE$16, 0);
            }
        }
        ...
        public java.util.Calendar getEndTimeEpisode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(ENDTIMEEPISODE$18, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public uk.nhs.nhsia.datastandards.ecds.EndTimeEpisodeType xgetEndTimeEpisode()
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.nhsia.datastandards.ecds.EndTimeEpisodeType)get_store().find_element_user(ENDTIMEEPISODE$18, 0);
                return target;
            }
        }
        ...
        public boolean isSetEndTimeEpisode()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(ENDTIMEEPISODE$18) != 0;
            }
        }
        ...
        public void setEndTimeEpisode(java.util.Calendar endTimeEpisode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(ENDTIMEEPISODE$18);
                }
        ...
        public void xsetEndTimeEpisode(uk.nhs.nhsia.datastandards.ecds.EndTimeEpisodeType endTimeEpisode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.EndTimeEpisodeType)get_store().add_element_user(ENDTIMEEPISODE$18);
                }
        ...
        public void unsetEndTimeEpisode()
        {
            ...
            {
                check_orphaned();
                get_store().remove_element(ENDTIMEEPISODE$18, 0);
            }
        }
        ...
        public uk.nhs.nhsia.datastandards.ecds.MultiProfOrDiscIndCodeType.Enum getMultiProfOrDiscIndCode()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(MULTIPROFORDISCINDCODE$22, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public uk.nhs.nhsia.datastandards.ecds.MultiProfOrDiscIndCodeType xgetMultiProfOrDiscIndCode()
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.nhsia.datastandards.ecds.MultiProfOrDiscIndCodeType)get_store().find_element_user(MULTIPROFORDISCINDCODE$22, 0);
                return target;
            }
        }
        ...
        public boolean isSetMultiProfOrDiscIndCode()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(MULTIPROFORDISCINDCODE$22) != 0;
            }
        }
        ...
        public void setMultiProfOrDiscIndCode(uk.nhs.nhsia.datastandards.ecds.MultiProfOrDiscIndCodeType.Enum multiProfOrDiscIndCode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(MULTIPROFORDISCINDCODE$22);
                }
        ...
        public void xsetMultiProfOrDiscIndCode(uk.nhs.nhsia.datastandards.ecds.MultiProfOrDiscIndCodeType multiProfOrDiscIndCode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.MultiProfOrDiscIndCodeType)get_store().add_element_user(MULTIPROFORDISCINDCODE$22);
                }
        ...
        public void unsetMultiProfOrDiscIndCode()
        {
            ...
            {
                check_orphaned();
                get_store().remove_element(MULTIPROFORDISCINDCODE$22, 0);
            }
        }
        ...
        public uk.nhs.nhsia.datastandards.ecds.RehabilitationAssessmentTeamTypeType.Enum getRehabilitationAssessmentTeamType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(REHABILITATIONASSESSMENTTEAMTYPE$24, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public uk.nhs.nhsia.datastandards.ecds.RehabilitationAssessmentTeamTypeType xgetRehabilitationAssessmentTeamType()
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.nhsia.datastandards.ecds.RehabilitationAssessmentTeamTypeType)get_store().find_element_user(REHABILITATIONASSESSMENTTEAMTYPE$24, 0);
                return target;
            }
        }
        ...
        public boolean isSetRehabilitationAssessmentTeamType()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(REHABILITATIONASSESSMENTTEAMTYPE$24) != 0;
            }
        }
        ...
        public void setRehabilitationAssessmentTeamType(uk.nhs.nhsia.datastandards.ecds.RehabilitationAssessmentTeamTypeType.Enum rehabilitationAssessmentTeamType)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(REHABILITATIONASSESSMENTTEAMTYPE$24);
                }
        ...
        public void xsetRehabilitationAssessmentTeamType(uk.nhs.nhsia.datastandards.ecds.RehabilitationAssessmentTeamTypeType rehabilitationAssessmentTeamType)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (uk.nhs.nhsia.datastandards.ecds.RehabilitationAssessmentTeamTypeType)get_store().add_element_user(REHABILITATIONASSESSMENTTEAMTYPE$24);
                }
        ...
        public void unsetRehabilitationAssessmentTeamType()
        {
            ...
            {
                check_orphaned();
                get_store().remove_element(REHABILITATIONASSESSMENTTEAMTYPE$24, 0);
            }
        }
        
        /**
         * Gets the "ConsultantEpisodeLengthOfStayAdjustment" element
         */
        public uk.nhs.nhsia.datastandards.ecds.ConsultantEpisodeLengthOfStayAdjustmentStructure getConsultantEpisodeLengthOfStayAdjustment()
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.nhsia.datastandards.ecds.ConsultantEpisodeLengthOfStayAdjustmentStructure target = null;
                target = (uk.nhs.nhsia.datastandards.ecds.ConsultantEpisodeLengthOfStayAdjustmentStructure)get_store().find_element_user(CONSULTANTEPISODELENGTHOFSTAYADJUSTMENT$26, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        /**
         * True if has "ConsultantEpisodeLengthOfStayAdjustment" element
         */
        public boolean isSetConsultantEpisodeLengthOfStayAdjustment()
        {
            synchronized (monitor())
            {
                check_orphaned();
                return get_store().count_elements(CONSULTANTEPISODELENGTHOFSTAYADJUSTMENT$26) != 0;
            }
        }
        
        /**
         * Sets the "ConsultantEpisodeLengthOfStayAdjustment" element
         */
        public void setConsultantEpisodeLengthOfStayAdjustment(uk.nhs.nhsia.datastandards.ecds.ConsultantEpisodeLengthOfStayAdjustmentStructure consultantEpisodeLengthOfStayAdjustment)
        {
            generatedSetterHelperImpl(consultantEpisodeLengthOfStayAdjustment, CONSULTANTEPISODELENGTHOFSTAYADJUSTMENT$26, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
        }
        
        /**
         * Appends and returns a new empty "ConsultantEpisodeLengthOfStayAdjustment" element
         */
        public uk.nhs.nhsia.datastandards.ecds.ConsultantEpisodeLengthOfStayAdjustmentStructure addNewConsultantEpisodeLengthOfStayAdjustment()
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.nhsia.datastandards.ecds.ConsultantEpisodeLengthOfStayAdjustmentStructure target = null;
                target = (uk.nhs.nhsia.datastandards.ecds.ConsultantEpisodeLengthOfStayAdjustmentStructure)get_store().add_element_user(CONSULTANTEPISODELENGTHOFSTAYADJUSTMENT$26);
                return target;
            }
        }
        
        /**
         * Unsets the "ConsultantEpisodeLengthOfStayAdjustment" element
         */
        public void unsetConsultantEpisodeLengthOfStayAdjustment()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_element(CONSULTANTEPISODELENGTHOFSTAYADJUSTMENT$26, 0);
            }
        }
        ...
        public uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure[] getOverseasVisitorStatusArray()
        {
            synchronized (monitor())
            {
                ...
                get_store().find_all_element_users(OVERSEASVISITORSTATUS$28, targetList);
        ...
        public uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure getOverseasVisitorStatusArray(int i)
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure)get_store().find_element_user(OVERSEASVISITORSTATUS$28, i);
                if (target == null)
                {
        ...
        public int sizeOfOverseasVisitorStatusArray()
        {
            ...
            {
                check_orphaned();
                return get_store().count_elements(OVERSEASVISITORSTATUS$28);
            }
        }
        ...
        {
            check_orphaned();
            arraySetterHelper(overseasVisitorStatusArray, OVERSEASVISITORSTATUS$28);
        }
        ...
        {
            generatedSetterHelperImpl(overseasVisitorStatus, OVERSEASVISITORSTATUS$28, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
        }
        ...
        public uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure insertNewOverseasVisitorStatus(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure target = null;
                target = (uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure)get_store().insert_element_user(OVERSEASVISITORSTATUS$28, i);
                return target;
            }
        }
        ...
        public uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure addNewOverseasVisitorStatus()
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure target = null;
                target = (uk.nhs.nhsia.datastandards.ecds.OverseasVisitorStatusStructure)get_store().add_element_user(OVERSEASVISITORSTATUS$28);
                return target;
            }
        }
        ...
        public void removeOverseasVisitorStatus(int i)
        {
            ...
            {
                check_orphaned();
                get_store().remove_element(OVERSEASVISITORSTATUS$28, i);
            }
        }
    }
}
