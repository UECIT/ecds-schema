 ...
 */
public class EDPEntryRemovalStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.EDPEntryRemovalStructure
{
    private static final long serialVersionUID = 1L;
    
    public EDPEntryRemovalStructureImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
