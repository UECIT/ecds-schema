 ...
 */
public class PatientCharacteristicsGeneralStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.PatientCharacteristicsGeneralStructure
{
    private static final long serialVersionUID = 1L;
    
    public PatientCharacteristicsGeneralStructureImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName MENTALHEALTHACTLEGALSTATUSCLASSIFICATIONCODEONADMISSION$8 = 
        new javax.xml.namespace.QName("http://www.nhsia.nhs.uk/DataStandards/XMLschema/CDS/ns", "MentalHealthActLegalStatusClassificationCode_OnAdmission");
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.MentalHealthActLegalStatusClassificationCodeType.Enum getMentalHealthActLegalStatusClassificationCodeOnAdmission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(MENTALHEALTHACTLEGALSTATUSCLASSIFICATIONCODEONADMISSION$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.MentalHealthActLegalStatusClassificationCodeOnAdmissionType xgetMentalHealthActLegalStatusClassificationCodeOnAdmission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.MentalHealthActLegalStatusClassificationCodeOnAdmissionType target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.MentalHealthActLegalStatusClassificationCodeOnAdmissionType)get_store().find_element_user(MENTALHEALTHACTLEGALSTATUSCLASSIFICATIONCODEONADMISSION$8, 0);
            return target;
        }
    }
     ...
     */
    public boolean isSetMentalHealthActLegalStatusClassificationCodeOnAdmission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(MENTALHEALTHACTLEGALSTATUSCLASSIFICATIONCODEONADMISSION$8) != 0;
        }
    }
     ...
     */
    public void setMentalHealthActLegalStatusClassificationCodeOnAdmission(uk.nhs.nhsia.datastandards.ecds.MentalHealthActLegalStatusClassificationCodeType.Enum mentalHealthActLegalStatusClassificationCodeOnAdmission)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(MENTALHEALTHACTLEGALSTATUSCLASSIFICATIONCODEONADMISSION$8);
            }
            target.setEnumValue(mentalHealthActLegalStatusClassificationCodeOnAdmission);
        }
    }
     ...
     */
    public void xsetMentalHealthActLegalStatusClassificationCodeOnAdmission(uk.nhs.nhsia.datastandards.ecds.MentalHealthActLegalStatusClassificationCodeOnAdmissionType mentalHealthActLegalStatusClassificationCodeOnAdmission)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.nhsia.datastandards.ecds.MentalHealthActLegalStatusClassificationCodeOnAdmissionType)get_store().add_element_user(MENTALHEALTHACTLEGALSTATUSCLASSIFICATIONCODEONADMISSION$8);
            }
            target.set(mentalHealthActLegalStatusClassificationCodeOnAdmission);
        }
    }
     ...
     */
    public void unsetMentalHealthActLegalStatusClassificationCodeOnAdmission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MENTALHEALTHACTLEGALSTATUSCLASSIFICATIONCODEONADMISSION$8, 0);
        }
    }
}
