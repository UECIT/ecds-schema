 ...
 */
public class FinishedDeliveryEpisodeStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure
{
    private static final long serialVersionUID = 1L;
    
    public FinishedDeliveryEpisodeStructureImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure.EpisodeCharacteristics getEpisodeCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure.EpisodeCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure.EpisodeCharacteristics)get_store().find_element_user(EPISODECHARACTERISTICS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEpisodeCharacteristics(uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure.EpisodeCharacteristics episodeCharacteristics)
    {
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure.EpisodeCharacteristics addNewEpisodeCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure.EpisodeCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure.EpisodeCharacteristics)get_store().add_element_user(EPISODECHARACTERISTICS$0);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class EpisodeCharacteristicsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.FinishedDeliveryEpisodeStructure.EpisodeCharacteristics
    {
        private static final long serialVersionUID = 1L;
