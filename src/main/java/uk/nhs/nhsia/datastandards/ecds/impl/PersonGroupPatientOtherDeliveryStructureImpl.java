 ...
 */
public class PersonGroupPatientOtherDeliveryStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.PersonGroupPatientOtherDeliveryStructure
{
    private static final long serialVersionUID = 1L;
    
    public PersonGroupPatientOtherDeliveryStructureImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.PatientCharacteristicsOtherDeliveryGeneralStructure getPatientCharacteristicsGeneralStructure()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.PatientCharacteristicsOtherDeliveryGeneralStructure target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.PatientCharacteristicsOtherDeliveryGeneralStructure)get_store().find_element_user(PATIENTCHARACTERISTICSGENERALSTRUCTURE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPatientCharacteristicsGeneralStructure(uk.nhs.nhsia.datastandards.ecds.PatientCharacteristicsOtherDeliveryGeneralStructure patientCharacteristicsGeneralStructure)
    {
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.PatientCharacteristicsOtherDeliveryGeneralStructure addNewPatientCharacteristicsGeneralStructure()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.PatientCharacteristicsOtherDeliveryGeneralStructure target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.PatientCharacteristicsOtherDeliveryGeneralStructure)get_store().add_element_user(PATIENTCHARACTERISTICSGENERALSTRUCTURE$2);
            return target;
        }
    }
