 ...
 */
public class HospitalProviderSpellStructureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure
{
    private static final long serialVersionUID = 1L;
    
    public HospitalProviderSpellStructureImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.AdmissionCharacteristics getAdmissionCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.AdmissionCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.AdmissionCharacteristics)get_store().find_element_user(ADMISSIONCHARACTERISTICS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAdmissionCharacteristics(uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.AdmissionCharacteristics admissionCharacteristics)
    {
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.AdmissionCharacteristics addNewAdmissionCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.AdmissionCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.AdmissionCharacteristics)get_store().add_element_user(ADMISSIONCHARACTERISTICS$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.DischargeCharacteristics getDischargeCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.DischargeCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.DischargeCharacteristics)get_store().find_element_user(DISCHARGECHARACTERISTICS$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDischargeCharacteristics(uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.DischargeCharacteristics dischargeCharacteristics)
    {
     ...
     */
    public uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.DischargeCharacteristics addNewDischargeCharacteristics()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.DischargeCharacteristics target = null;
            target = (uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.DischargeCharacteristics)get_store().add_element_user(DISCHARGECHARACTERISTICS$2);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class AdmissionCharacteristicsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.AdmissionCharacteristics
    {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class DischargeCharacteristicsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.nhsia.datastandards.ecds.HospitalProviderSpellStructure.DischargeCharacteristics
    {
        private static final long serialVersionUID = 1L;
